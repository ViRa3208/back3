...
<body>
<div class="main">
  <form class="formula" action="forma.php" method="POST">
    ...
    <div class="form_item">
      ...
      <label class="form_label labe">
        <select name="superpowers" multiple="multiple">
          <option value=0 selected="selected">Сдать все контрольные вовремя</option>
          <option value=1>Сдать сессию с первого раза</option>
          <option value=2>Посещать все пары</option>
        </select>
      </label>
    </div>
    <div class="form_item">
